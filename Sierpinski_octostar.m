function [V, T] = Sierpinski_octostar(nb_it, option_display)
%% Sierpinski_octostar : function compute, display, and save
% a Sierpinski octostar at any iteration number / depth level.
%
...
%
%
% Example #1 : computes and displays the simple Sierpinski octostar at iteration 3
%
% Sierpinski_octostar(3);
%
%
% Example #2 : computes and displays the Sierpinski octostar at iteration 5
...
%% Body
% Summits of original octostar (living in the unit sphere R(O,1))
V1 = [0 0 1];
V2 = [2*sqrt(2)/3 0 -1/3];
